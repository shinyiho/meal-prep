...
function at() {
  ...
  document.getElementById("Beef").innerHTML = `${validtag.Chilli+validtag.Bourguignon*2+validtag.Curry*2}`;
  ...
  document.getElementById("KidneyBeans").innerHTML = `${validtag.Chilli}`;
   ...
   document.getElementById("Zucchini").innerHTML = ``;
   document.getElementById("rice").innerHTML = `${validtag.Bourguignon}`;
   document.getElementById("garlic").innerHTML = `${validtag.Bourguignon*0.5}`;
   document.getElementById("onion").innerHTML = `${validtag.Bourguignon*2}`;
   document.getElementById("whitewine").innerHTML = ``;
   document.getElementById("redwine").innerHTML = `${validtag.Bourguignon}`;
   document.getElementById("carrot").innerHTML = `${validtag.Bourguignon}`;
   document.getElementById("chickbrew").innerHTML = `${validtag.Bourguignon*0.5}`;
  document.getElementById("tomatopaste").innerHTML = `${validtag.Bourguignon*0.5}`;
  document.getElementById("potato").innerHTML = ``;
  document.getElementById("drumstick").innerHTML = ``;
  ...
  document.getElementById("Cheese").innerHTML = `${validtag.Chilli*0.1+validtag.AvocadoToast*0.1}`;
